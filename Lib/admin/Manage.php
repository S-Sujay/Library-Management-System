...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark">
	...
	<li class="nav-item"> <a class="nav-link" href="Home.php"> <b> Home </b> </a> </li>
			...
			<li class="nav-item active"> <a class="nav-link" href="Manage.php"> <b> Manage </b> </a> </li>
	...
	<div class="container p-3 my-3 mt-5 bg-dark text-white" style="width:40%;margin-left:8%; border-radius:10px; float:left;">
		<h4 class="font-weight-bold"> Add a Book </h4>
		<form name="f4" action = "Addbook.php" method = "POST">  
		...
		<div class="form-check-inline">
		  <label class="form-check-label">
	    	<input type="checkbox" class="form-check-input" value="True" name="yes" >Yes
	  		</label>
			</div>
			<div class="form-check-inline">
	  		<label class="form-check-label">
	    	<input type="checkbox" class="form-check-input" value="False" name="no" >No
	  	</label>
		</div>
		</div>
        
		<div class="form-group text-right">     
            <input class="btn btn-primary" style="width:20%" id=buttonadd type =  "submit" value = "Add" />  <br>
		</div>  
        </form>  
	</div>
	...
	<div class="container p-3 my-3 mt-5 bg-dark text-white" style="width:40%; margin-right:8%; border-radius:10px; float:right;">
		<h4 class="font-weight-bold"> Remove a Book </h4>
	<form name="f5" action = "Removebook.php" method = "POST">  
        <div class="form-group">     
        <label> Book ID: </label>  
        <input class="form-control" id=ID type = "number" name  = "Bookid" required/>  
		</div>  
        <div class="form-group text-right">     
        <input class="btn btn-primary" id=buttonrm type =  "submit" value = "Remove" />  
		</div>  
	</form>  
	</div>
