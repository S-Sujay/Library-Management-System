...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark">
	...
	<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item active"> <a class="nav-link" href="Requests.php"> <b> Requests </b> </a> </li>
...
<?php
	...
	$query = "Select * from Renew_requests";
...
echo "<table class='table table-bordered text-center table-hover'>
	...
	while( $row = mysqli_fetch_assoc($result) )
	{
	 ...
	 echo "<td> {$row['Req_Book_id']} </td>";
	 echo "<td> {$row['Req_USN']} </td>";
	 echo "  <input type='hidden' name='Bookid' value={$row['Req_Book_id']}>";
	 echo "  <input type='hidden' name='USN' value={$row['Req_USN']}>";
	 echo "<td>  <input class='btn btn-success btn-sm' type='submit' value='Approve'> </td>";
	 echo "</form>";
	 echo "</tr>";	
	}
	echo"</tbody></table> ";
